...
public class SimpleDequeWithIterator<T> implements DequeWithIteratorInterface<T> {
    private T[] theDeque;
    private int size;

    @SuppressWarnings("unchecked")
    public SimpleDequeWithIterator(int initsize) {
    ...
    private class myDequeIterator implements Iterator<T> {
        ...
        public T next() {
            if (hasNext())
                ...
                throw new NoSuchElementException("Iterating past end of deque.");
        }
